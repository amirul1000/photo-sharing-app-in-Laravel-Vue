    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="">
                ...
                <button type="button" class="btn btn-secondary mt-2" v-on:click="saveFriend()">Save</button>
            </form>
        </div>
    </div>
    ...
    methods: {	   
        ...
        async saveFriend() {
            try {
                ...
                let res = await axios.post('/api/admin/friend/store', this.friend);
                toastr.success('friend saved Successfully')
                this.friend = {}
            } catch (error) {
			    console.log(error);
