        ...
        <div class="card-body">
            <!--<form action="">-->
               <div class="form-group">
                ...
                <button type="button" class="btn btn-secondary mt-2" v-on:click="updatePost()">Update</button>
            <!--</form>-->
        </div>
    </div>
    ...
    methods: {
        ...
        async updatePost() {
            try {
                ...
                let res = await axios.post('/api/admin/post/update/', this.post);
        ...
        async getPost(id) {
            let res = await axios.get(`/api/admin/post/edit/${id}`);
